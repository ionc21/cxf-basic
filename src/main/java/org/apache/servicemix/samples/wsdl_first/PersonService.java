 ...
 * 2016-09-26T22:19:06.961+02:00
 * Generated source version: 2.7.0.redhat-610379
 * 
 */
@WebServiceClient(name = "PersonService", 
                  wsdlLocation = "file:/D:/work/cxf-basic/src/main/resources/wsdl/person.wsdl",
...
public class PersonService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/work/cxf-basic/src/main/resources/wsdl/person.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PersonService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/work/cxf-basic/src/main/resources/wsdl/person.wsdl");
        }
        WSDL_LOCATION = url;
    }
